...
public class TechnologyGroupsValidator {
    ...
    public void checkTechnologyGroups(final Set<String> technologyGroups) {
    ...
    private List<FieldError> getNamesErrors(final Set<String> technologyGroups) {
        return technologyGroups.stream()
                .map(this::checkTechnologyGroupName)
                .filter(Objects::nonNull)
                .collect(Collectors.toList());
    }
    ...
    private FieldError checkTechnologyGroupsSize(final Set<String> technologyGroups) {
